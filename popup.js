...
const channelThumbnailInput = document.querySelector(
  ".js-channel-thumbnail-input"
);
...
function findCard(title) {
  ...
  let cards = document.querySelectorAll(
    ".ytd-rich-item-renderer:not(#content)"
  );
  ...
  chrome.storage.local.get("thumbnailProperties", (result) => {
    ...
    let channelThumbnailFromExtension =
      result.thumbnailProperties.channelThumbnail;
    let channelThumbnailFromYoutube = document.querySelector(
